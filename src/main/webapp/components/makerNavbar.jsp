    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="margin-left: 140px;">
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link user-name-text" aria-current="page"
                            href="${pageContext.request.contextPath}/trainee/dashboard">Home</a>
                    </li>
                </ul>
                <ul class="nav justify-content-end">
                ...
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link text-blue user-name-text " aria-current="page"
                            href="${pageContext.request.contextPath}/trainee/labs">Lab</a>
                    </li>
                </ul>
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link text-blue user-name-text " aria-current="page"
                            href="${pageContext.request.contextPath}/trainee/labTests">Lab Test</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <script>
        ...
        function submitPassword() {
            ...
            if (newPassword === confirmPassword) {
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/api/trainee/changePassword",
