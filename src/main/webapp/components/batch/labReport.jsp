    ...
    <div class="row m-0">
        ...
        <div id="testReportSection" class="col-9 m-0 p-2 " style="width: 80%;">
            <div class="border border-gray shadow p-3 bg-white rounded">
                <h3 class="mb-2 text-center">Lab Information</h3>
                <div class="row px-2">
                    <div class="col-md-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title">Batch Name</h5>
                                <p class="card-text">${labReportPayload.batchCode}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text">${labReportPayload.labName}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text">${labReportPayload.totalScore}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    <table id="myTable" class="table">
                        ...
                        <tbody>
                            <c:forEach var="labDetail" items="${labReportPayload.labDetails}">
                                <tr>
                                    <td>${labDetail.traineeId}</td>
                                    <td>${labDetail.traineeName}</td>
                                    <td>${labDetail.obtainedScore}</td>
                                    <td>
                                        <fmt:formatNumber
                                        value="${(labDetail.obtainedScore / labReportPayload.totalScore) * 100}"
                                        maxFractionDigits="2" />
                                    </td>
                                    <td>${labDetail.labStatus}</td>
