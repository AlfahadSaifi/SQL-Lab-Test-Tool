                ...
                <tr>
                  ...
                  <td>
                    <a
                      ...
                      href="${pageContext.request.contextPath}/admin/editTraineeDetail?id=${e.employeeId}"
                      >Edit/View</a
                    >
                  </td>
                  <td>
                    <a
                      ...
                      href="${pageContext.request.contextPath}/admin/viewDetailedBatchReports?id=${batchId}"
                      >Report</a
                    >
                  </td>
                </tr>
